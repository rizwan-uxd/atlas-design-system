...
| 0.3 | `ThemeProvider.tsx` + `useTheme.ts` (light/dark via `useColorScheme`) | ⬜ Not started |
| 0.4 | `shadowHelper.ts` — cross-platform shadow (iOS shadow props vs. Android `elevation`) | ⬜ Not started |
