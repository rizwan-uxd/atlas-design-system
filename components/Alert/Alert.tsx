 ...
 *   - Reduced motion: enter animation suppressed via CSS media query
 *
 * Props:
 ...
 *   onDismiss   — callback when dismiss is clicked
 *
 * Token compliance: all values via semantic tokens in Alert.module.css.
 */
